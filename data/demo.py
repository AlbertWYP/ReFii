...
import sys
sys.path.append('/data1/yipeng_wei/DIRE-main/guided-diffusion') # folder_path为要引用的文件夹路径
from guided_diffusion import dire

parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument(
    "-f", "--file", default="/data1/yipeng_wei/DIRE-main/1.jpeg", type=str, help="path to image file or directory of images"
)
parser.add_argument(
    "-m",
    "--model_path",
    type=str,
    default="/data1/yipeng_wei/DIRE-main/imagenet_adm.pth",
)
...
#state_dict = torch.jit.load(args.model_path, map_location="cpu")
